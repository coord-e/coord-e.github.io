      ...
      <ul class={styles.carousel.container}>
        <WorkItem title="scopion programming language" image={images.scopion}>
          ...
          <div class={styles.carousel.icons}>
            <IconLink src={faLink} href="https://scopion.coord-e.com/" target="_blank" class={styles.carousel.icon}>
              Website
            </IconLink>
        ...
        <WorkItem title="cart" image={images.cart}>
          ...
          <div class={styles.carousel.icons}>
            <IconLink src={faLink} href="https://qiita.com/coord-e/items/78fb116aa40ac4e9579b" target="_blank" class={styles.carousel.icon}>
              Qiita
            </IconLink>
            <IconLink src={faGithub} href="https://github.com/coord-e/cart" target="_blank" class={styles.carousel.icon}>
              GitHub
            </IconLink>
          </div>
        </WorkItem>
        <WorkItem title="validate.now" image={images.validate}>
          ...
          <div class={styles.carousel.icons}>
            <IconLink src={faLink} href="https://validate.now.sh" target="_blank" class={styles.carousel.icon}>
              validate.now.sh
            </IconLink>
            <IconLink src={faGithub} href="https://github.com/coord-e/validate.now" target="_blank" class={styles.carousel.icon}>
              GitHub
            </IconLink>
          </div>
        </WorkItem>
        <WorkItem title="Ozone Project" image={images.ozone}>
          ...
          <div class={styles.carousel.icons}>
            <IconLink src={faLink} href="http://ozone.y-modify.org/" target="_blank" class={styles.carousel.icon}>
              Website
            </IconLink>
          </div>
        </WorkItem>
        <WorkItem title="DSP6951 Driver Library for Arduino" image={images.dsp6951}>
          ...
          <div class={styles.carousel.icons}>
            <IconLink src={faGithub} href="https://github.com/coord-e/DSP6951" target="_blank" class={styles.carousel.icon}>
              GitHub
            </IconLink>
          </div>
        </WorkItem>
        <WorkItem title="ILI9328 Driver Library for Arduino" image={images.ili9328}>
          ...
          <div class={styles.carousel.icons}>
            <IconLink src={faGithub} href="https://github.com/coord-e/ili9328SPI" target="_blank" class={styles.carousel.icon}>
              GitHub
            </IconLink>
          </div>
        </WorkItem>
